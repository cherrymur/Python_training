...
class DbFixture:
    ...
    def __init__(self, host, name, user, password):
        ...
        self.connection = pymysql.connect(host=host, database=name, user=user, password=password, autocommit=True) # last parametr - clear cache
    ...
    def get_contact_list(self):
        ...
        try:
            ...
            for row in cursor:
                (id, firstname, lastname, address, homephone, mobilephone, workphone,
